//
// SalesByCategoryMasterViewController.swift
// Employees
//
...
class SalesByCategoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([SalesByCategory]?, Error?) -> Void) -> Void)?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryID, CategoryName, ProductName", value: "\(salesbycategory.categoryID!), \(salesbycategory.categoryName!), \(salesbycategory.productName!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SalesByCategoryDetailViewController
...
extension SalesByCategoryMasterViewController: EntitySetUpdaterDelegate {
