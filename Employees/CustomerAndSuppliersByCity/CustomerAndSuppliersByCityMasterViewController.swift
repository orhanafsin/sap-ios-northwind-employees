//
// CustomerAndSuppliersByCityMasterViewController.swift
// Employees
//
...
class CustomerAndSuppliersByCityMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([CustomerAndSuppliersByCity]?, Error?) -> Void) -> Void)?
    private var entities: [CustomerAndSuppliersByCity] = [CustomerAndSuppliersByCity]()
    private let logger = Logger.shared(named: "CustomerAndSuppliersByCityMasterViewControllerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CompanyName, Relationship", value: "\(customerandsuppliersbycity.companyName!), \(customerandsuppliersbycity.relationship!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CustomerAndSuppliersByCityDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! CustomerAndSuppliersByCityDetailViewController
...
extension CustomerAndSuppliersByCityMasterViewController: EntitySetUpdaterDelegate {
