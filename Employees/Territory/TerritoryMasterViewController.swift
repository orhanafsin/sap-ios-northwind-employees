//
// TerritoryMasterViewController.swift
// Employees
//
...
class TerritoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Territory]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! TerritoryDetailViewController
...
extension TerritoryMasterViewController: EntitySetUpdaterDelegate {
