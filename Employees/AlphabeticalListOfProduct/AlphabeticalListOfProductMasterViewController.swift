//
// AlphabeticalListOfProductMasterViewController.swift
// Employees
//
...
class AlphabeticalListOfProductMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([AlphabeticalListOfProduct]?, Error?) -> Void) -> Void)?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryName, Discontinued, ProductID, ProductName", value: "\(alphabeticallistofproduct.categoryName!), \(alphabeticallistofproduct.discontinued!), \(alphabeticallistofproduct.productID!), \(alphabeticallistofproduct.productName!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! AlphabeticalListOfProductDetailViewController
...
extension AlphabeticalListOfProductMasterViewController: EntitySetUpdaterDelegate {
