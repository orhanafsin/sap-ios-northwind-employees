//
// CurrentProductListMasterViewController.swift
// Employees
//
...
class CurrentProductListMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([CurrentProductList]?, Error?) -> Void) -> Void)?
    private var entities: [CurrentProductList] = [CurrentProductList]()
    private let logger = Logger.shared(named: "CurrentProductListMasterViewControllerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "ProductID, ProductName", value: "\(currentproductlist.productID!), \(currentproductlist.productName!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CurrentProductListDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! CurrentProductListDetailViewController
...
extension CurrentProductListMasterViewController: EntitySetUpdaterDelegate {
