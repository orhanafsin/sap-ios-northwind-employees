//
// ProductsByCategoryMasterViewController.swift
// Employees
//
...
class ProductsByCategoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ProductsByCategory]?, Error?) -> Void) -> Void)?
    private var entities: [ProductsByCategory] = [ProductsByCategory]()
    private let logger = Logger.shared(named: "ProductsByCategoryMasterViewControllerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryName, Discontinued, ProductName", value: "\(productsbycategory.categoryName!), \(productsbycategory.discontinued!), \(productsbycategory.productName!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductsByCategoryDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! ProductsByCategoryDetailViewController
...
extension ProductsByCategoryMasterViewController: EntitySetUpdaterDelegate {
