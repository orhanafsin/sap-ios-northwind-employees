...
class OrderMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Order]?, Error?) -> Void) -> Void)?
...
extension OrderMasterViewController: EntitySetUpdaterDelegate {
