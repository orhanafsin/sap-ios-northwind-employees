//
// ProductsAboveAveragePriceMasterViewController.swift
// Employees
//
...
class ProductsAboveAveragePriceMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ProductsAboveAveragePrice]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductsAboveAveragePriceDetailViewController
...
extension ProductsAboveAveragePriceMasterViewController: EntitySetUpdaterDelegate {
