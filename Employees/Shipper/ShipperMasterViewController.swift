//
// ShipperMasterViewController.swift
// Employees
//
...
class ShipperMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Shipper]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ShipperDetailViewController
...
extension ShipperMasterViewController: EntitySetUpdaterDelegate {
