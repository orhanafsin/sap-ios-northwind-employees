//
// SummaryOfSalesByQuarterMasterViewController.swift
// Employees
//
...
class SummaryOfSalesByQuarterMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([SummaryOfSalesByQuarter]?, Error?) -> Void) -> Void)?
    private var entities: [SummaryOfSalesByQuarter] = [SummaryOfSalesByQuarter]()
    private let logger = Logger.shared(named: "SummaryOfSalesByQuarterMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SummaryOfSalesByQuarterDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! SummaryOfSalesByQuarterDetailViewController
...
extension SummaryOfSalesByQuarterMasterViewController: EntitySetUpdaterDelegate {
