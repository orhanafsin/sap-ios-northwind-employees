//
// SummaryOfSalesByYearMasterViewController.swift
// Employees
//
...
class SummaryOfSalesByYearMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([SummaryOfSalesByYear]?, Error?) -> Void) -> Void)?
    private var entities: [SummaryOfSalesByYear] = [SummaryOfSalesByYear]()
    private let logger = Logger.shared(named: "SummaryOfSalesByYearMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SummaryOfSalesByYearDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! SummaryOfSalesByYearDetailViewController
...
extension SummaryOfSalesByYearMasterViewController: EntitySetUpdaterDelegate {
