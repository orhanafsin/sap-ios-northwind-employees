//
// CustomerDemographicMasterViewController.swift
// Employees
//
...
class CustomerDemographicMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([CustomerDemographic]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CustomerDemographicDetailViewController
...
extension CustomerDemographicMasterViewController: EntitySetUpdaterDelegate {
