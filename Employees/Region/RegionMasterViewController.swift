//
// RegionMasterViewController.swift
// Employees
//
...
class RegionMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Region]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! RegionDetailViewController
...
extension RegionMasterViewController: EntitySetUpdaterDelegate {
