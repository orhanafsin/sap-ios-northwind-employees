//
// OrderDetailsExtendedMasterViewController.swift
// Employees
//
...
class OrderDetailsExtendedMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([OrderDetailsExtended]?, Error?) -> Void) -> Void)?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "Discount, OrderID, ProductID, ProductName, Quantity, UnitPrice", value: "\(orderdetailsextended.discount!), \(orderdetailsextended.orderID!), \(orderdetailsextended.productID!), \(orderdetailsextended.productName!), \(orderdetailsextended.quantity!), \(orderdetailsextended.unitPrice!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! OrderDetailsExtendedDetailViewController
...
extension OrderDetailsExtendedMasterViewController: EntitySetUpdaterDelegate {
