//
// SalesTotalsByAmountMasterViewController.swift
// Employees
//
...
class SalesTotalsByAmountMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([SalesTotalsByAmount]?, Error?) -> Void) -> Void)?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CompanyName, OrderID", value: "\(salestotalsbyamount.companyName!), \(salestotalsbyamount.orderID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SalesTotalsByAmountDetailViewController
...
extension SalesTotalsByAmountMasterViewController: EntitySetUpdaterDelegate {
