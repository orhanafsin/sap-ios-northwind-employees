//
// OrdersQryMasterViewController.swift
// Employees
//
...
class OrdersQryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([OrdersQry]?, Error?) -> Void) -> Void)?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CompanyName, OrderID", value: "\(ordersqry.companyName!), \(ordersqry.orderID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! OrdersQryDetailViewController
...
extension OrdersQryMasterViewController: EntitySetUpdaterDelegate {
