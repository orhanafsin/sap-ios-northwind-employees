//
// EmployeeMasterViewController.swift
// Employees
//
...
class EmployeeMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Employee]?, Error?) -> Void) -> Void)?
...
extension EmployeeMasterViewController: EntitySetUpdaterDelegate {
