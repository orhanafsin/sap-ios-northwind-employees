//
// OrderSubtotalMasterViewController.swift
// Employees
//
...
class OrderSubtotalMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([OrderSubtotal]?, Error?) -> Void) -> Void)?
    private var entities: [OrderSubtotal] = [OrderSubtotal]()
    private let logger = Logger.shared(named: "OrderSubtotalMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! OrderSubtotalDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! OrderSubtotalDetailViewController
...
extension OrderSubtotalMasterViewController: EntitySetUpdaterDelegate {
